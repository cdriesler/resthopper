...
class ConstructDateInput_hour_h extends ResthopperParameter {
	...
	public description: string = "Hour of day (must be between 0 and 23)"
	public isOptional: boolean = false;
	public typeName: string = "Integer"
...
class ConstructDateInput_minute_m extends ResthopperParameter {
	...
	public nickName: string = "m";
	public description: string = "Minute of the hour (must be between 0 and 59)"
	public isOptional: boolean = false;
	public typeName: string = "Integer"
...
class ConstructDateInput_second_s extends ResthopperParameter {
	...
	public description: string = "Second of the minute (must be between 0 and 59)"
	public isOptional: boolean = false;
	public typeName: string = "Integer"
